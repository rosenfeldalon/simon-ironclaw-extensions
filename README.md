...
IRONCLAW_SIMON_CALENDAR_BUNDLE_VERSION=0.2.1 \
...
`simon_google_calendar` `0.2.1` is the current read/write hosted-install candidate. Its local lab gate is the report from `/Users/alonr/projects/simon-ironclaw-lab`:
